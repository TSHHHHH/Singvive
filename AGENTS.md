...
- **`npm run lint` is `oxlint --max-warnings=27`** — a ratchet pinning the existing warning count so new warnings fail CI. If you genuinely remove a warning, lower the number.
