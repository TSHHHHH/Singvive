...
export const ITEMS: Record<string, ItemDef> = {
  ...
  // The haze mask everyone already owned. Wears out as it filters.
  n95_mask: { id: 'n95_mask', name: 'N95 Mask', w: 1, h: 1, weight: 0.1, effect: { kind: 'misc' }, value: 9, stackable: false, maxStack: 1, color: '#d8d5cc', slot: 'head', modifiers: { defenseBonus: 1 } },
  ...
  kevlar_vest: { id: 'kevlar_vest', name: 'Kevlar Vest', w: 2, h: 3, weight: 3.5, effect: { kind: 'misc' }, value: 40, stackable: false, maxStack: 1, color: '#2f3a2a', slot: 'body', modifiers: { defenseBonus: 5 }, exotic: true, scarcity: 0.25 },
  sbo_vest: { id: 'sbo_vest', name: 'SBO Load-Bearing Vest', w: 2, h: 2, weight: 1.8, effect: { kind: 'misc' }, value: 34, stackable: false, maxStack: 1, color: '#4a5240', slot: 'body', modifiers: { defenseBonus: 2, weightCapacityBonus: 10 }, exotic: true, scarcity: 0.3 },
  // --- Armour: offHand ---
  riot_shield: { id: 'riot_shield', name: 'Riot Shield', w: 2, h: 3, weight: 4.0, effect: { kind: 'misc' }, value: 30, stackable: false, maxStack: 1, color: '#37506b', slot: 'offHand', modifiers: { defenseBonus: 4, attackBonus: -1 }, exotic: true, scarcity: 0.3 },
