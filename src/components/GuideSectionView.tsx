    ...
    <section className="min-w-0">
      {showTitle && (
        <h3
          className={
            compactTitle
              ? 'mb-1.5 text-plate uppercase text-signal/80'
              : 'mb-1.5 text-plate uppercase text-white/75'
          }
        >
          {section.title}
        </h3>
      ...
      <ul className="mt-2 flex flex-col gap-1.5 text-body leading-relaxed text-white/55">
